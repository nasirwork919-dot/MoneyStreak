/*
  ...
  This is the complete, production-ready database schema for BigMoney.
  Copy and paste this entire script into your Supabase SQL Editor and click "Run".
  
  Features:
  - Complete user management with referral system
  - Ticket tracking for all entry types ($3, $5, free quiz, referrals)
  - Real-time revenue aggregation
  - Admin panel with comprehensive analytics
  - Cryptographic draw verification system
  - Row Level Security (RLS) for data protection
  - Auto-generated entry numbers and referral codes
  - Charity partnership tracking
*/
...
WHERE table_schema = 'public' 
    AND table_name IN ('users', 'tickets', 'referrals', 'draws', 'daily_revenue', 'quiz_attempts', 'admin_users', 'charity_partners', 'user_sessions');